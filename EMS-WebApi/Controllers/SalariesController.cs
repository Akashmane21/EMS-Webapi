...
namespace EMS_WebApi.Controllers
{
    ...
    public class SalariesController : ControllerBase
    {
        ...
        public SalariesController(ContextDB context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Salary>> PostSalary(Salary salary)
        {
          if (_context.Salary == null)
          {
              return Problem("Entity set 'ContextDB.Salary'  is null.");
          }
            _context.Salary.Add(salary);
            await _context.SaveChangesAsync();

            return CreatedAtAction("GetSalary", new { id = salary.Salary_Id }, salary);
        }
        ...
        {
            return (_context.Salary?.Any(e => e.Salary_Id == id)).GetValueOrDefault();
        }
    }
}
